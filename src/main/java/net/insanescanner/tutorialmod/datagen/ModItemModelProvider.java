...
public class ModItemModelProvider extends ItemModelProvider {
    ...
    protected void registerModels() {
        ...
        basicItem(ModItems.MEMOITE_HORSE_ARMOR.get());
        ...
        trimmedArmorItem(ModItems.MEMOITE_HELMET);
        trimmedArmorItem(ModItems.MEMOITE_CHESTPLATE);
        trimmedArmorItem(ModItems.MEMOITE_LEGGING);
