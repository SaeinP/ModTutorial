...
public class ModArmorMaterials {
    public static final Holder<ArmorMaterial> MEMOITE_ARMOR_MATERIAL = register("memoite", Util.make(new EnumMap<>(ArmorItem.Type.class),
            attribute -> {
            ...
            }), 15, 4f, 0.1f, () -> ModItems.MEMOITE.get());
