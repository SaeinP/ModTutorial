...
public class ModEnchantments {
    ...
    public static void bootstrap(BootstrapContext<Enchantment> context){
        ...
        )).exclusiveWith(enchantments.getOrThrow(EnchantmentTags.DAMAGE_EXCLUSIVE)).withEffect(EnchantmentEffectComponents.POST_ATTACK, EnchantmentTarget.ATTACKER,EnchantmentTarget.VICTIM,
